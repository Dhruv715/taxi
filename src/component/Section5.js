...
function Section5() {
  return (
    <>
        ...
        <h1 className='font-extrabold text-center text-4xl lg:text-6xl lg:text-center sm:text-5xl md:text-5xl lg:px-10 lg:py-4 md:py-3 sm:py-4' style={{fontFamily:'poppins'}}>Why Choose Style Taxi</h1>
        ...
        <div className="parentvox flex flex-col lg:flex-row md:flex-col sm:flex-col my-5 justify-center items-center">
            ...
            <div className="lg:w-1/2 md:w-full sm:w-full px-2">
                <ol type="1" className='w-5/5 lg:w-5/5 md:w-full sm:w-full px-5 text-left font-sans font-medium text-base' style={{fontFamily:'poppins'}} >
