...
function Section2() {
  return (
    <div className='flex flex-col  lg:flex-row w-screen md:flex-row  overflow-hidden'>
      <div className='lg:w-1/2 text-center md:w-1/2 sm:w-full sm:text-center'>
        <img className='mx-5  my-3 mx-auto w-4/5 sm:w-2/3  md:w-3/5 sm:mx-auto sm:w-1/2' style={{ borderRadius: '20px' }} src="http://old3.commonsupport.com/wp/conexi/wp-content/uploads/2020/04/book-1-1.jpg" alt="" />
      ...
      <div className='lg:w-1/2 sm:text-center md:w-1/2 sm:w-full bg-black py-5 md:py-10 px-2 '>
        ...
        <div className='tripform text-center mx-auto w-full sm:mx-auto sm:w-2/3 md:w-3/3 lg:w-2/3 ms-1 my-5'>
          ...
          <div className='flex w-full sm:w-2/2 my-2'>
            <button className='w-full m-2 semibtn2'>Book Now</button>
          </div>
        </div>
      </div>
    </div>
