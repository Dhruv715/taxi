  ...
  return (
    <>
      <div className='flex flex-col md:flex-col lg:flex-row bg-yellow-400 w-screen py-28 px-10'>
        ...
        <div className="lg:w-1/5 md:w-5/5 sm:w-2/3 lg:ms-20 sm:ms-0 md:ms-0 sm:mt-10 md:mt-10 lg:mt-0 lg:my-auto">
          <button className='bg-black text-white py-5 px-10 mt-4 rounded-full text-lg font-semibold w-full'>Book Taxi Now</button>
        </div>
      </div>
    </>
  );
